...
/** 学习应用地址 */
const APP_URL = 'https://github.com/rhouselyn/Gualingo'
...
function HowSection() {
  const steps = [
    ...
    { n: '02', t: '浏览字典', d: '查看分句翻译和词汇释义，随时查阅任意单词', c: '#FFD700' },
    { n: '03', t: '阶段一', d: '单词选择、句子翻译、听力理解', c: '#00BFFF' },
    { n: '04', t: '阶段二', d: '遮蔽填空、翻译重组', c: '#39FF14' },
    { n: '05', t: '错题回顾', d: '答错的题自动收集，强化练习直到掌握', c: '#BF5FFF' },
  ]
  return (
    <section className="py-16 md:py-24 px-4 md:px-8 bg-white border-y-4 border-black relative">
